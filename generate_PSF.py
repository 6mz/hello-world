...
def gen_example(psf_list, shape=(64, 64), psf_num=1):
    tfrecords_features = {}
...
class PSF(object):
    ...
    def fit(self, show=False, save=False):
        ...
        for j in range(self.PSFnumber):
            ...
            PSF = PSF / (self.fraction[j])
            self.PSFs.append(PSF / (self.iters))
        if show or save:
            #print(self.PSFs[0][35:40,25:30],'a')
           # print(self.PSFs[1][35:40,25:30],'b')
